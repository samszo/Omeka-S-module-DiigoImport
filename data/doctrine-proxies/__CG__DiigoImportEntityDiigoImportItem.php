...
namespace DoctrineProxies\__CG__\DiigoImport\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class DiigoImportItem extends \DiigoImport\Entity\DiigoImportItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'import', 'item', 'diigoKey', 'action'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DiigoImportItem $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setImport(\DiigoImport\Entity\DiigoImport $import)
    {
    ...
    public function setDiigoKey($diigoKey)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDiigoKey', [$diigoKey]);

        return parent::setDiigoKey($diigoKey);
    }
    ...
    public function getDiigoKey()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDiigoKey', []);

        return parent::getDiigoKey();
    }
